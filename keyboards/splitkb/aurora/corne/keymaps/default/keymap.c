...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        [0] = LAYOUT_split_3x5_3(
            LT(1,DE_Z), LT(5,DE_Y), LT(2,DE_U), LT(3,DE_A),     LCTL_T(DE_Q),       RCTL_T(DE_P),    LT(8,DE_B), DE_M,  DE_L, LGUI_T(DE_F),
            DE_C,       DE_S,       DE_I,       DE_E,           DE_O,               DE_D,            DE_T,       DE_N,  DE_R, DE_H,
            LT(4,DE_V), DE_X,       DE_UDIA,    LT(6,DE_ADIA),  LALT_T(DE_ODIA),    LALT_T(DE_W),    DE_G,       DE_SS, DE_J, DE_K,
                                                KC_ESC KC_TAB, LSFT_T(KC_SPC),     RSFT_T(KC_BSPC), KC_ENT, KC_DEL),
